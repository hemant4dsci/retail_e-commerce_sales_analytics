...
COPY calender
FROM
    'E:/Data Analytics Projects/walmart_sales_analytics_project/data/raw/calender.csv'
WITH
...
COPY channels
FROM
    'E:/Data Analytics Projects/walmart_sales_analytics_project/data/raw/channel.csv'
WITH
    (FORMAT CSV, HEADER TRUE, DELIMITER ',');
...
COPY geographies
FROM
    'E:/Data Analytics Projects/walmart_sales_analytics_project/data/raw/geography.csv'
WITH
    (FORMAT CSV, HEADER TRUE, DELIMITER ',');
...
FROM
    'E:/Data Analytics Projects/walmart_sales_analytics_project/data/raw/product_sub_category.csv'
WITH
    (FORMAT CSV, HEADER TRUE, DELIMITER ',');
...
COPY products
FROM
    'E:/Data Analytics Projects/walmart_sales_analytics_project/data/raw/products.csv'
WITH
    (FORMAT CSV, HEADER TRUE, DELIMITER ',');
...
COPY sales
FROM
    'E:/Data Analytics Projects/walmart_sales_analytics_project/data/raw/sales.csv'
WITH
    (FORMAT CSV, HEADER TRUE, DELIMITER ',');